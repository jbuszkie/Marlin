...
#define STRING_CONFIG_H_AUTHOR "(jbuszkie, Sidwinder X1)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Sidewinder X1- JB Build"
...
#define Z_MIN_PROBE_ENDSTOP_INVERTING false // Set to true to invert the logic of the probe. JB- Need to check on this?
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 437.16 }
